        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="<?php echo base_url('user/lap_harian'); ?>"><i class="fa fa-circle-o"></i> Permohonan izin Batu Bara</li>
                    <li><a href="<?php echo base_url('user/lap_bulanan'); ?>"><i class="fa fa-circle-o"></i> Permohonan Izin Sipa</a></li>
                    <li><a href="<?php echo base_url('user/lap_tahunan'); ?>"><i class="fa fa-circle-o"></i> Permohonan Izin Kelapa Sawit </a></li>
                    <li><a href="<?php echo base_url('user/lap_lain'); ?>"><i class="fa fa-circle-o"></i> Izin Lain Lain</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    <li><a href="<?php echo base_url('user/dok_kerja'); ?>"><i class="fa fa-circle-o"></i> Dokumen Kantor</a></li>
